...
type Comp struct {
	...
	CompType     string `gorm:"type:enum('mall','game','medical','hardware','software','network','finance','video','education','other');not null;"`
...
func (Comp) TableName() string {
	return consts.TablePrefix + "comp"
}
